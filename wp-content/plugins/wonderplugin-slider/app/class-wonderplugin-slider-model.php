...
class WonderPlugin_Slider_Model {
	...
	function generate_body_code($id, $has_wrapper) {
		...
		if ($item_row != null)
		{
			...
			if ( isset($data->paddingleft) && isset($data->paddingright) )
				$ret .= 'padding-left:' . $data->paddingleft . 'px;padding-right:' . $data->paddingright . 'px;';
			...
			$boolOptions = array('autoplay', 'randomplay', 'autoplayvideo', 'isresponsive', 'fullwidth', 'showtext', 'showtimer', 'showbottomshadow', 'navshowpreview', 'lightboxresponsive', 'lightboxshownavigation', 'lightboxshowtitle', 'lightboxshowdescription');
			...
			$valOptions = array('scalemode', 'arrowstyle', 'transition', 'loop', 'border', 'slideinterval', 
					...
					'textformat', 'textpositionstatic', 'textpositiondynamic', 'paddingleft', 'paddingright');
