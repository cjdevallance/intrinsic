<?php
/*
Single Post Template: [Recent Sales Page Template]
...
<section class="middle-section-downlevel">
	...
	<div class="two_thirds">
    	...
    	<div class="content-template-desktop">
        	...
        	<?php query_posts("cat=9&posts_per_page=100&orderby=date&order=ASC"); 
            ...
            <div class="left-column">
                ...
                <img src="<?php bloginfo( 'template_url' ); ?>/images/plhdr.png" alt="<?php the_title(); ?>">
