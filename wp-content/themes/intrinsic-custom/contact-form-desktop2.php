...
?>
            ...
            <form id="contact-main-form" name="contact_us_desktop2" method="post" action="<?php bloginfo( 'template_url' ); ?>/contact-form.php">
            ...
            <div class="search-table-button" style="width: 97%; margin: 5% 0 0; display: inline-block;">
            	<a href="javascript:validate_contact_us_desktop2();" class="search-form-button" id="send_message">Submit</a>
			</div>
