<?php
/*
Single Post Template: [New Yacht Brand Page Template Hatteras]
...
<section class="middle-section-downlevel">
	...
	<div class="two_thirds">
		...
		<div class="content-template-desktop">
			...
			<?php query_posts( 'cat=19&posts_per_page=100&orderby=date&order=ASC' ); 
			...
			<div class="third new-yacht">
                ...
                <a href="<?php echo $url; ?>"><?php echo $thumbsrc; ?></a><br>
		...
		<div style="width: 100%; display: block;"><p>Our sales office is located at Bay Bridge Marina in Stevensville, MD on Kent Island – just 15 minutes from Annapolis and a couple of hours from Virginia, Delaware, Washington D.C. and Ocean City, MD.</p></div>
	...
	<div class="content-template-mobile">
		...
		<div class="content-mobile">
			...
			<?php query_posts( 'cat=19&posts_per_page=100&orderby=title&order=ASC' ); 
			if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
