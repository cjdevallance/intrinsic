...
function checkform() {
    ...
    if (errors != "") {
        ...
        $.post('http://intrinsicyacht.com/wp-content/themes/intrinsic-custom/captcha-form/library/contact-submit.php', $("form#contact-main-form").serialize(), function (data) {
